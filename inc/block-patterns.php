 ...
 * @return void
 */
function sik_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'sik' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'sik' ) ),
		'header'   => array( 'label' => __( 'Headers', 'sik' ) ),
		'query'    => array( 'label' => __( 'Query', 'sik' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'sik' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'sik_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'sik_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'webpack_starter_kit/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'sik_register_block_patterns', 9 );
