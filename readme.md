...
- `npm run dev` - development webpack build (`webpack --mode development`).
- `npm run build` - production webpack build, with code minification enabled (`webpack --mode production`).
